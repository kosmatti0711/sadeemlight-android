...
public class VideoPreviewActivity extends AppCompatActivity implements UniversalVideoView.VideoViewCallback {
    ...
    public static void showActivity(Context parent, String videoPath)
    {
        m_videoPath = videoPath;

        Intent intent = new Intent(parent, VideoPreviewActivity.class);
    ...
    private void setVideoAreaSize() {
        mVideoLayout.post(new Runnable() {
            ...
            public void run() {
                ...
                mVideoView.setVideoPath(m_videoPath);
